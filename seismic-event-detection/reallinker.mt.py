...
def realmt(realid, fqueue, odata):
    ...
    while True:
        ...
        print(fr"./real -D{D} -R{R} -G{G} -S{S} -V{V} {station} ../../{path} {ttime}")
...
def mkstation(inname):
    ...
    for line in infile.readlines():
        ...
        outfile.write(f"{lon:.4f} {lat:.4f} {sline[0]} {sline[1]} {sline[2]} {dep:3f}\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', default="gansu/out.pnsn.txt", help="拾取文件")       
    parser.add_argument('-o', '--output', default="gansu/pnsn.real.txt", help="输出文件名")   
    parser.add_argument('-s', '--station', default="gansu/china.loc", help="输出文件名")                                                         
