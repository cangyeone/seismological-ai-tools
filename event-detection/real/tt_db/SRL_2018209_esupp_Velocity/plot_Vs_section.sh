...
c="93/133"     ##### longitudes for the start and end points of profile
#
PROJ="-JX6.0i/-1.2i"
...
##### make cp.
makecpt -Cseis -T3.0/4.95/0.1 -D150/0/0/0/0/150 -Z  > vs.cpt
##### plot basemap
psbasemap $PROJ $BOUNDS -Ba5f1:"Longitude":/a20f10:"Depth(km)":nWSe:."":  -K  >$PSFILE 
####
grdimage $PROJ $BOUNDS  interpolated.grd -Cvs.cpt -V   -K -O >>$PSFILE 
####
grdcontour interpolated.grd  $PROJ $BOUNDS  -Gd5c -A0.5+s6p+gwhite -O -K  -W0.5p/255  >> $PSFILE
#####
psscale -Cvs.cpt -Ba0.4g0.2/:"Vs (km/s)": -D6.4i/0.6i/1.2i/0.08i  -O  >> $PSFILE
